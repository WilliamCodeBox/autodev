// test-yaml.mjs — 全面校验内联 yaml-lite 对 autodev 状态文件的往返稳定性与格式正确性。
// 从 autodev-extension/ 目录运行：node tools/autodev/lib/test-yaml.mjs
import { parse, stringify, parseInlineMap } from './yaml-lite.mjs';
...
console.log(`\nyaml-lite: ${pass} passed, ${fail} failed`);
